...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div id="content">
                <form action="${pageContext.request.contextPath}/checkout.htm" method="POST" class="beta-form-checkout">
                    <div class="row">
                        <div class="col-sm-6">
                                ...
                                <div class="your-order-body" style="padding: 0px 10px">
                                    <div class="your-order-item">
                                        <div>
                                            ...
                                            <!--  one item	 -->
                                            <div class="media">
                                                <img src="${pageContext.request.contextPath}/${item.getProduct().getImage()}" alt="" class="pull-left" width="133" height="89">
                                                     <div class="media-body">
                                                    <p class="font-large">${item.getProduct().getName_Pr()}</p>
                                                </div>
                                            </div>
                                            <!-- end one item -->
                                           </c:forEach> 
                                    ...
                                    <div class="your-order-item">
                                        ...
                                        <div class="pull-right"><h5 class="color-black">${sessionScope.totalPrice}</h5></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
